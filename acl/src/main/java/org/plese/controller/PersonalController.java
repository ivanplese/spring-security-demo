...
public class PersonalController {
    ...
    public String getEdit(@RequestParam(value="id", required=true) Long id,
        ...
        model.addAttribute("messageAttribute", personalService.getSingle(id));

        // Add source to model to help us determine the source of the JSP page
        model.addAttribute("source", "Personal");

        // This will resolve to /WEB-INF/pages/crud-personal/editpage.jsp
    ...
    public String getEditPage(@ModelAttribute("messageAttribute") PersonalMessage message,
        ...
        // Delegate to service
        if (personalService.edit(message) == true) {
            // Add result to model
        ...
        // This will resolve to /WEB-INF/pages/crud-personal/resultpage.jsp
    ...
    public String getAdd(Model model) {
        ...
        // This is the formBackingOBject
        model.addAttribute("messageAttribute", new PersonalMessage());

        // Add source to model to help us determine the source of the JSP page
        model.addAttribute("source", "Personal");

        // This will resolve to /WEB-INF/pages/crud-personal/addpage.jsp
    ...
    public String getAddPage(@ModelAttribute("messageAttribute") PersonalMessage message, Model model) {
        ...
        // Delegate to service
        if (personalService.add(message)) {
    ...
    public String getDeletePage(@RequestParam(value="id", required=true) Long id,
        ...
        // Create new post
        IMessage message = new PersonalMessage();
        // Assign id
        message.setId(id);

        // Delegate to service
        if (personalService.delete(message)) {
            // Add result to model
    ...
    public GenericService getPersonalService() {
        return personalService;
    }

    public void setPersonalService(GenericService personalService) {
