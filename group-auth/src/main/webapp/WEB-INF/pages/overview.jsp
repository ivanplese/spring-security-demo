...
<div style="width: 600px" >
    <div>
        <table style="border: 1px solid; width: 500px; text-align:center">
            ...
            <tbody>
            <c:forEach items="${adminmessages}" var="message">
                <c:url var="editUrl" value="/admin/edit?id=${message.id}" />
                <c:url var="deleteUrl" value="/admin/delete?id=${message.id}" />
...
<div style="width: 600px" >
    <div>
        <table style="border: 1px solid; width: 500px; text-align:center">
            ...
            <tbody>
            <c:forEach items="${personalmessages}" var="message">
                <c:url var="editUrl" value="/personal/edit?id=${message.id}" />
                <c:url var="deleteUrl" value="/personal/delete?id=${message.id}" />
...
<div style="width: 600px" >
    <div>
        <table style="border: 1px solid; width: 500px; text-align:center">
            <caption>Public Messages</caption>
            <thead style="background:#fcf">
            <tr>
                <th>Date</th>
                <th>Message</th>
